public class CrcUtil {
	...
	public static String calcCrc16(byte[] data) {
		String hilo = String.format("%04x", calcCrc16(data, 0, data.length));
		/**
		 * 高低位反转
		 */
		String lohi = hilo.substring(2, 4) + hilo.substring(0, 2);
		return lohi;
	}
	...
	public static void main(String[] args) {
		String value = "010300700002";
		String crc = CrcUtil.calcCrc16(HexTools.HexStringtoBytes(value));
